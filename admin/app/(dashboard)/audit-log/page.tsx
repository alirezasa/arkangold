...
const ACTION_LABELS: Record<string, string> = {
  ...
  "discount_code.create": "ایجاد کد تخفیف",
  "discount_code.update": "ویرایش / فعال‌سازی کد تخفیف",
  "discount_code.delete": "حذف کد تخفیف",
  "shop.packaging.create": "ایجاد طرح بسته‌بندی",
  "shop.packaging.update": "ویرایش / فعال‌سازی طرح بسته‌بندی",
  "shop.packaging.delete": "حذف طرح بسته‌بندی",
  "shop.packaging.assign_all": "اختصاص طرح بسته‌بندی به همه محصولات",
  "shop.packaging.image.upload": "آپلود تصویر طرح بسته‌بندی",
  "shop.packaging.image.delete": "حذف تصویر طرح بسته‌بندی",
  "shop.packaging.settings.update": "تنظیم آستانه بسته‌بندی رایگان",
  "shop.product.packaging.update": "تعیین بسته‌بندی‌های محصول",
