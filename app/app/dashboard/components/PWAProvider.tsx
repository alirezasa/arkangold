...
export default function PWAProvider({
  ...
  return (
    <>
      ...
      {isOffline && (
        <div
          className="fixed top-0 left-0 right-0 z-[9999] flex items-center justify-center gap-2 py-2 px-4 text-[13px] font-bold text-white"
      ...
      {isInstallable && !isIOS && !isInstalled && !installDismissed && (
        <div
          className="fixed bottom-[76px] left-3 right-3 z-[9998] rounded-[14px] p-4 shadow-xl lg:bottom-4 lg:left-auto lg:right-4 lg:w-[340px]"
          style={{
        ...
        >
          <div className="flex items-start gap-3">
            <div
              className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-[10px] text-[20px] font-black"
              style={{
      ...
      {isIOS && !isInstalled && !iosDismissed && (
        <div
          className="fixed bottom-[76px] left-3 right-3 z-[9998] rounded-[14px] p-4 shadow-xl"
          style={{
            backgroundColor: "var(--color-emerald)",
            border: "1px solid rgba(197,160,89,.3)",
          }}
        ...
        >
          <button
            ...
            className="absolute left-3 top-3 p-1 text-white/40 hover:text-white/80 transition-colors"
            aria-label="بستن"
          >
            <i className="ti ti-x text-[16px]" aria-hidden="true" />
          </button>
          ...
          {/* Arrow pointing to bottom nav area */}
          <div
